...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { body: @about.body, integer: @about.integer, lang_id: @about.lang_id, title: @about.title }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { body: @about.body, integer: @about.integer, lang_id: @about.lang_id, title: @about.title }
    assert_redirected_to about_path(assigns(:about))
  end
