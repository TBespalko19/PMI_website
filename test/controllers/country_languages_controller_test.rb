...
class CountryLanguagesControllerTest < ActionController::TestCase
  ...
  test "should create country_language" do
    assert_difference('CountryLanguage.count') do
      post :create, country_language: { country_id: @country_language.country_id, lang_id: @country_language.lang_id, title: @country_language.title }
    end
  ...
  test "should update country_language" do
    patch :update, id: @country_language, country_language: { country_id: @country_language.country_id, lang_id: @country_language.lang_id, title: @country_language.title }
    assert_redirected_to country_language_path(assigns(:country_language))
  end
