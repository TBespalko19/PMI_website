...
class CertificationsControllerTest < ActionController::TestCase
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post :create, certification: { body: @certification.body, integer: @certification.integer, lang_id: @certification.lang_id, title: @certification.title }
    end
  ...
  test "should update certification" do
    patch :update, id: @certification, certification: { body: @certification.body, integer: @certification.integer, lang_id: @certification.lang_id, title: @certification.title }
    assert_redirected_to certification_path(assigns(:certification))
  end
